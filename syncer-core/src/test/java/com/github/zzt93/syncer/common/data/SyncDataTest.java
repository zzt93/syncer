...
public class SyncDataTest {
  ...
  public void testToStringDefault() {
    ...
    assertEquals("SyncData(inner=Meta{dataId=mysql-bin.00001/4/6/0, context=true, connectionIdentifier='null', syncByQuery=null, esScriptUpdate=null, updated=null, partitionField=null, copy=0, extraQueryContext=null}, result=SyncResult(super=SyncResultBase(super=SyncMeta(eventType=WRITE, repo=test, entity=test, id=1234, primaryKeyName=id), fields={}, extras=null, before=null)))",
        write.toString());
    assertEquals("SyncData(inner=Meta{dataId=mysql-bin.00001/4/6/0, context=true, connectionIdentifier='null', syncByQuery=null, esScriptUpdate=null, updated=null, partitionField=null, copy=0, extraQueryContext=null}, result=SyncResult(super=SyncResultBase(super=SyncMeta(eventType=WRITE, repo=test, entity=test, id=1234, primaryKeyName=id), fields={}, extras=null, before=null)))",
        write.toString());
  }
